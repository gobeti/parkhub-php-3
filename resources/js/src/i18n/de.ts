export const de = {
  ...
  admin: {
    ...
    announcements: {
      ...
      messagePlaceholder: 'Nachricht der Ankündigung...',
      ...
      edit: 'Bearbeiten',
      delete: 'Löschen',
      confirmDelete: 'Diese Ankündigung wirklich löschen?',
      created: 'Ankündigung erstellt.',
      updated: 'Ankündigung aktualisiert.',
      deleted: 'Ankündigung gelöscht.',
      saveFailed: 'Speichern fehlgeschlagen.',
      deleteFailed: 'Löschen fehlgeschlagen.',
      validationError: 'Titel und Nachricht sind erforderlich.',
      empty: 'Noch keine Ankündigungen vorhanden.',
      createdAt: 'Erstellt',
      expiresAt: 'Läuft ab',
    },
    overview: {
